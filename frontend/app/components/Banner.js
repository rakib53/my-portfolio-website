  ...
  return (
    <div className="max-w-screen-xl w-full h-[760px] mx-auto flex justify-between items-center">
      <div className="max-w-[550px] w-full">
        ...
        <h1 className="text-white text-4xl mb-5 font-inter font-semibold">
          Passionate <b className="text-yellow-500">full stack</b> developer
          creating seamless web experiences.
        </h1>
        <div className="flex gap-3">
          <button className="px-5 py-2 text-lg font-medium bg-yellow-500 border-2 border-transparent rounded-md hover:bg-[#112240] hover:border-yellow-500 text-white transition duration-300">
            Let's talk
          </button>
        </div>
        <div className="flex mt-4">
          <Link
            href="https://www.facebook.com/mrrakibrs/"
            target="_blank"
          ...
          <Link
            href="https://www.linkedin.com/in/mrrakibs/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <Link
            href="https://twitter.com/mr_rakibs"
            target="_blank"
            rel="noopener noreferrer"
          >
